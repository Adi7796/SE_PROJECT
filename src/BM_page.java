 ...
 * @author adity
 */
public class BM_page extends javax.swing.JFrame {

    /**
     * Creates new form BM_page
     */
    public BM_page() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NONE", "See Salary Details", "Check or Edit tasks assigned", "View Personal Details of Employees", "View or edit Branch Details" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(selected.equals("View Personal Details of Employees"))
        {
           BM_PersDet next=new BM_PersDet();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BM_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
